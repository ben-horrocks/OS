...
#define MAX_CHARACTER 115
extern TCB tcb[];							// task control block
char last_command[MAX_CHARACTER];
...
//				inBuffer[0] = 0;
				...
				{
					tcb[task].signal &= ~mySIGTSTP;
					tcb[task].signal &= ~mySIGSTOP;
				}
