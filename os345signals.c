...
//		else if (tcb[curTask].signal & mySIGKILL)
//		{
...
{
	printf("Sending stops\n");
    sigSignal(-1, mySIGSTOP);
	printf("Done Sending Stops\n");
	return;
}
